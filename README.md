...
<tr><td width="50%"><a href="docs/images/analise.png"><img src="docs/images/analise.png" alt="Análise do deck"></a><br><b>Análise do deck</b><br><sub>Contagens, valor, curva de mana e cores dos custos.</sub></td><td width="50%"><a href="docs/images/quadro.png"><img src="docs/images/quadro.png" alt="Quadro de relações"></a><br><b>Quadro de relações</b><br><sub>Constelação 3D: cartas flutuando por tema, linhas de quem fornece para quem aproveita, equilíbrio dos temas e sugestões da coleção.</sub></td></tr>
</table>
