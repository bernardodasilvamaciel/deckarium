...
<table>
<tr><td width="50%"><a href="docs/images/inicio.png"><img src="docs/images/inicio.png" alt="Página inicial"></a><br><b>Página inicial</b><br><sub>O que o site faz, os quatro passos e cada módulo, com os comandantes mais jogados em leque.</sub></td><td width="50%"><a href="docs/images/quadro.png"><img src="docs/images/quadro.png" alt="Quadro de relações"></a><br><b>Quadro de relações</b><br><sub>Constelação 3D: cartas flutuando por tema, linhas de quem fornece para quem aproveita, equilíbrio dos temas e sugestões da coleção.</sub></td></tr>
