...
function uiIcon(string $name): string
{
    $paths = [
        ...
        'trade'=>'<path d="M3 12.6V4.5a1.5 1.5 0 0 1 1.5-1.5h8.1a1.5 1.5 0 0 1 1.06.44l6.4 6.4a1.5 1.5 0 0 1 0 2.12l-8.1 8.1a1.5 1.5 0 0 1-2.12 0l-6.4-6.4A1.5 1.5 0 0 1 3 12.6Z"/><circle cx="7.6" cy="7.6" r="1.4"/>',
