...
function pageHeader(string $title): void
{
    ...
    $section = match ($route) { 'editions.php','edition.php'=>'sets', 'collection.php'=>'collection', 'decks.php'=>'decks','status.php'=>'status',default=>'cards' };
    ...
    foreach ([['cards','/','Catálogo'],['sets','/editions.php','Edições'],['collection','/collection.php','Minha coleção'],['decks','/decks.php','Meus decks'],['status','/status.php','Status']] as [$key,$url,$label]) {
